            ...
            <div className="w-full max-w-md relative z-10">
                <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl transition-all hover:border-white/20">
                    <div className="mb-8 text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-400">Sign in to track your digital carbon footprint</p>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-white/5 text-center">
                        <p className="text-sm text-gray-500">
                            ...
                            <Link href="/signup" className="font-medium text-emerald-400 hover:text-emerald-300 hover:underline decoration-emerald-500/30 underline-offset-4 transition-all">
                                Create free account
                            </Link>
                        </p>
                    </div>
